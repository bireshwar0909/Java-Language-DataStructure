...
public class Java02SuffixArrayMed extends Java00SuffixArray {
  ...
  public Java02SuffixArrayMed(String text) {
    super(toIntArray(text));
  }

  public Java02SuffixArrayMed(int[] text) {
    super(text);
  }
  ...
  public static void main(String[] args) {
    ...
    Java02SuffixArrayMed sa = new Java02SuffixArrayMed("ABBABAABAA");
