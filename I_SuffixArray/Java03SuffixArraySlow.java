...
public class Java03SuffixArraySlow extends Java00SuffixArray {
  ...
  public Java03SuffixArraySlow(String text) {
    super(toIntArray(text));
  }

  public Java03SuffixArraySlow(int[] text) {
    super(text);
  }
  ...
  public static void main(String[] args) {
    Java03SuffixArraySlow sa = new Java03SuffixArraySlow("ABBABAABAA");
